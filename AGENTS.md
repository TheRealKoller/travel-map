...
## Travel Map Project Information

### GitHub Repository & Project

- GitHub Username: **TheRealKoller**
- Repository: **TheRealKoller/travel-map**
- GitHub Project (Issues & Tasks): https://github.com/users/TheRealKoller/projects/3

### Issue Implementation Workflow (CRITICAL)

When working on an issue, you MUST follow this exact workflow:
...
- Implement the issue requirements in the feature branch
- Create meaningful, atomic commits throughout development
- Each commit should represent a logical unit of work
- Use descriptive commit messages that explain WHY, not just WHAT

#### 3. Quality Assurance

Before creating a pull request, run ALL of the following:

- **Tests**: `php artisan test --compact` (all tests must pass)
- **Code Formatting**: `vendor/bin/pint --dirty` (format PHP code)
...
- Evaluate each comment for relevance and value
- **Implement sensible suggestions** that improve code quality, security, or maintainability
- **Ask the user** if uncertain about whether to implement a suggestion
- Create additional commits to address review feedback
- Do NOT blindly implement all suggestions - use judgment

#### 7. Final Checks

- Ensure all review feedback is addressed
- Re-run quality assurance checks (tests, linters, formatters)
...
- Reference issue numbers when relevant: "Add marker export (#42)"
- Examples:
    - "Add Unsplash image fetching for markers (#42)"
    - "Fix map zoom reset on route calculation (#23)"
    - "Refactor Trip model relationships for better performance"
