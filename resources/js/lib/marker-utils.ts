...
export const getIconSvgForType = (type: MarkerType): string => {
    const svgIcons: Record<MarkerType, string> = {
        ...
        [MarkerType.Leisure]:
            '<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M7 22V5l5-3 5 3v17l-5-3z"/><path d="M7 8h10"/></svg>',
