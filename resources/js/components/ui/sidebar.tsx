...
function Sidebar({
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        ...
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          data-testid="sidebar-mobile-sheet"
          ...
          side={side}
        >
          <div className="flex h-full w-full flex-col" data-testid="sidebar-content">{children}</div>
        </SheetContent>
      </Sheet>
    )
  }
  ...
  return (
    <>
      {/* Overlay for sidebar - rendered outside of sidebar container */}
      {state === "expanded" && (
        <div
          data-testid="sidebar-overlay"
          className="fixed inset-0 z-40 bg-black/50 transition-opacity hidden md:block"
