                    ...
                    <div className="max-h-80 overflow-y-auto border-t border-gray-200 sm:max-h-96 dark:border-gray-700">
                        <ul className="space-y-1 p-3">
                            {availableMarkers.map((marker) => {
                                ...
                                const tourCount: number = getMarkerCountInTour(
                                    marker.id,
                                );
                                return (
                                    <li
                                    ...
                                    >
                                        <div
                                            className={cn(
                                                'flex cursor-pointer items-start gap-2 rounded bg-gray-50 p-2 text-xs transition-all hover:bg-gray-100 sm:p-2 sm:text-sm dark:bg-gray-800 dark:hover:bg-gray-700',
                                                isSelected &&
                                        ...
                                        >
                                            <div className="min-w-0 flex-1">
                                                <div className="mb-1 leading-snug font-medium text-gray-900 dark:text-gray-100">
                                                    {marker.name ||
                                                        'Unnamed Location'}
                                                </div>
                                            ...
                                            <Button
                                                variant="ghost"
                                                size="icon"
                                                className="h-9 w-9 shrink-0 p-0 text-green-600 hover:bg-green-50 hover:text-green-700 sm:h-11 sm:w-11 dark:text-green-400 dark:hover:bg-green-950 dark:hover:text-green-300"
                                                onClick={(e) => {
                                                    e.stopPropagation();
                                                    onAddMarkerToTour(
                                                        marker.id,
