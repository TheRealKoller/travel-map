...
it('generates static image URL with markers and routes', function () {
    $markers = [
...
it('generates static image URL with multiple routes', function () {
    $markers = [
        ['latitude' => 52.5200, 'longitude' => 13.4050], // Berlin
...
it('handles empty routes gracefully', function () {
    $markers = [
...
it('handles routes with empty geometry', function () {
...
it('simplifies long route geometry to avoid URL length limits', function () {
    $markers = [
        ['latitude' => 52.5200, 'longitude' => 13.4050],
        ['latitude' => 48.1351, 'longitude' => 11.5820],
    ];
...
it('returns null when no markers provided', function () {
...
it('returns null when no access token configured', function () {
