...
class StoreRouteRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'transit_details.steps.*.distance' => 'required_with:transit_details.steps|numeric|min:0',
            'transit_details.steps.*.duration' => 'required_with:transit_details.steps|numeric|min:0',
            'transit_details.steps.*.transit' => 'nullable|array',
            'transit_details.steps.*.transit.departure_stop' => 'required_with:transit_details.steps.*.transit|array',
            'transit_details.steps.*.transit.departure_stop.name' => 'nullable|string|max:255',
            'transit_details.steps.*.transit.arrival_stop' => 'required_with:transit_details.steps.*.transit|array',
            'transit_details.steps.*.transit.arrival_stop.name' => 'nullable|string|max:255',
            'transit_details.steps.*.transit.line' => 'required_with:transit_details.steps.*.transit|array',
